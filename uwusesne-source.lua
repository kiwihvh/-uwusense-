...
{
    --rage
    antidefensive = Menu.Switch("Global","<uwusense> Rage", "Anti-Defensive", false),
    autopeek = Menu.Switch("Global","<uwusense> Rage", "Quick Peek", false),
    disable_os = Menu.Switch("Global","<uwusense> Rage", "Disable FL on Hide Shots", false),
    idealtick = Menu.Switch("Global","<uwusense> Rage", "Idealtick", false, "Works when autopeek"),
    add_idealtick = Menu.MultiCombo("Global","<uwusense> Rage", "Idealtick Options", {"Freestand", "Override Damage", "Safe Head"}, 0),
    idealtick_damage = Menu.SliderInt("Global","<uwusense> Rage","Idealtick Damage", 10, 0, 130),
    air_hitchance = Menu.Switch("Global","<uwusense> Rage", "In-Air Hitchance", false),
    air_hitchance_value = Menu.SliderInt("Global","<uwusense> Rage","Air Hitchance Value", 50, 1, 100),
    ns_hitchance = Menu.Switch("Global","<uwusense> Rage", "Noscope Hitchance", false),
    ns_hitchance_value = Menu.SliderInt("Global","<uwusense> Rage","NS Hitchance Value", 50, 1, 100),

    --visuals
    state_panel = Menu.Switch("Visuals","<uwusense> Main","State Panel", false),
    ...
    --indicators
    indicators = Menu.MultiCombo("Visuals","<uwusense> Indicators","Indicators", {"<uwusense> #1", "<uwusense> #2", "<uwusense> #3", "Ideal Yaw", "Skeet"}, 0),
    add_indicators = Menu.MultiCombo("Visuals","<uwusense> Indicators","Additional Indicators", {"Freestand", "Exploit", "Damage", "Others"}, 0),
    damage_indicator = Menu.Switch("Visuals","<uwusense> Indicators", "Damage Indicator", false),
    ...
    alpha = Menu.SliderInt("Visuals","<uwusense> UI", "Box Alpha", 75, 0, 255),
    holo_on_tp = Menu.Switch("Visuals","<uwusense> UI","Disable in Thirdperson", false),
    binds_x = Menu.SliderInt("Visuals","<uwusense> UI", "X", 300, 0, x),
    binds_y = Menu.SliderInt("Visuals","<uwusense> UI", "Y", 300, 0, y),
    specs_x = Menu.SliderInt("Visuals","<uwusense> UI", "X ", 300, 0, x),
    specs_y = Menu.SliderInt("Visuals","<uwusense> UI", "Y ", 500, 0, y),

    --misc
    hitlogs = Menu.Switch("Misc","<uwusense> Misc","Hitlogs", false),
    hitlogs_type = Menu.MultiCombo("Misc","<uwusense> Misc", "Hitlogs Type", {"Custom", "Console", "Event"}, 0),
    console = Menu.SwitchColor("Misc", "<uwusense> Misc", "Console Color Changer", false, Color.new(1.0, 1.0, 1.0)),
    hitsound = Menu.Combo("Misc","<uwusense> Misc","Hitsound", {"Disable","Skeet", "Alternative", "Custom"}, 0),
    custom_hitsound = Menu.TextBox("Misc","<uwusense> Misc","Filepath", 64, "uwusense/hitsound/hitsound.wav"),
    wireframe = Menu.Switch("Misc","<uwusense> Misc","Molotov Wireframe", false),
    ignorez = Menu.Switch("Misc","<uwusense> Misc","Ignore-Z", false),
...
aa[0] =
{
    antiaims = Menu.Switch("Anti-Aim","<uwusemse> Main","Enable Anti Aim's", false),
    tp_in_air = Menu.Switch("Anti-Aim","<uwusemse> Main","Teleport In Air", false),
    fake_flick = Menu.Switch("Anti-Aim","<uwusemse> Main","Fake Flick", false),
    on_key = Menu.Switch("Anti-Aim","<uwusemse> Main","Legit AA", false),
    antibackstab = Menu.Switch("Anti-Aim","<uwusemse> Main","Anti Backstab", false),
    manual = Menu.Combo("Anti-Aim","<uwusemse> Main", "Override Yaw Base", {"Disable", "Forward", "Backward", "Right", "Left", "At Target", "Freestanding"}, 0, "Bind it"),
    antiaim = Menu.Combo("Anti-Aim","<uwusemse> Main", "Conditions", state, 0),
}
for i = 1, 6 do
    aa[i] = {
        custom_enable = Menu.Switch("Anti-Aim","<uwusense> " .. state[i], string.format("Enable %s Anti Aim", state[i]), false,string.format("Override %s settings", state[i])),
        custom_yaw_base = Menu.Combo("Anti-Aim","<uwusense> " .. state[i], "Yaw Base", {"Forward", "Backward", "Right", "Left", "At Target", "Freestanding"}, 1),
        custom_yaw_add_left = Menu.SliderInt("Anti-Aim","<uwusense> " .. state[i], "Yaw Add Left", 0, -180, 180),
        custom_yaw_add_right = Menu.SliderInt("Anti-Aim","<uwusense> " .. state[i], "Yaw Add Right", 0, -180, 180),
        custom_yaw_modifier = Menu.Combo("Anti-Aim","<uwusense> " .. state[i], "Yaw Modifier", {"Disabled", "Center", "Offset", "Random", "Spin"}, 0),
        custom_modifier_degree = Menu.SliderInt("Anti-Aim","<uwusense> " .. state[i], "Modifier Degree", 0, -180, 180),
        custom_fake_type = Menu.Combo("Anti-Aim","<uwusense> " .. state[i],"Fake Type", {"Static","Jitter","Random"}, 0),
        custom_left_limit = Menu.SliderInt("Anti-Aim","<uwusense> " .. state[i], "Left Limit", 60, 0, 60),
        custom_right_limit = Menu.SliderInt("Anti-Aim","<uwusense> " .. state[i], "Right Limit", 60, 0, 60),
        custom_left_limit2 = Menu.SliderInt("Anti-Aim","<uwusense> " .. state[i], "Left Limit [2]", 60, 0, 60),
        custom_right_limit2 = Menu.SliderInt("Anti-Aim","<uwusense> " .. state[i], "Right Limit [2]", 60, 0, 60),
        custom_options = Menu.MultiCombo("Anti-Aim","<uwusense> " .. state[i],"Fake Options", {"Avoid Overlap","Jitter","Randomize Jitter", "Anti Bruteforce"}, 0),
        custom_lby = Menu.Combo("Anti-Aim","<uwusense> " .. state[i],"LBY Mode", {"Disabled","Opposite","Sway"}, 1),
        custom_fs = Menu.Combo("Anti-Aim","<uwusense> " .. state[i],"Freestanding Desync", {"Off","Peek Fake","Peek Real"}, 0),
        custom_onshot = Menu.Combo("Anti-Aim","<uwusense> " .. state[i],"Desync On Shot", {"Disabled","Opposite","Freestanding","Switch"}, 0),
    }
end
local preset = Menu.Button("Anti-Aim","<uwusemse> Main", "Load Default Preset", "Load Default Preset", function()
...
CreateDir("nl\\uwusense\\")
--info
Menu.Text("Global","<uwusense> Info","Welcome to <uwusense>, "..Cheat.GetCheatUserName().."!")

local get_discord = Menu.Button("Global","<uwusense> Info","Discord", "Discord", function()
    Panorama.Open().SteamOverlayAPI.OpenExternalBrowserURL("https://discord.gg/UgNBwwuCCF")
end)

local get_font = Menu.Button("Global","<uwusense> Info","Font Download", "Font Download", function()
    CreateDir("nl\\uwusense\\fonts\\")
    Download('https://fontsforyou.com/downloads/99851-smallestpixel7', 'nl\\uwusense\\fonts\\pixel.ttf')
    logs[#logs+1] = {("<uwusense> Font installed, restart script!"), GlobalVars.tickcount + 300, 0}
end)

CreateDir("csgo\\sound\\uwusense\\")
CreateDir("csgo\\sound\\uwusense\\hitsound\\")
Download('https://cdn.discordapp.com/attachments/856592298132242432/931265632861818930/skeet.wav', 'csgo\\sound\\uwusense\\hitsound\\hitsound.wav')

Menu.Text("Global","<uwusense> Info","Hitsound Filepath: csgo/sounds | File type .wav")
Menu.Text("Global","<uwusense> Info","Thanks for buy! ")
...
local modes_combo = Menu.Combo("Visuals","<uwusense> ragdolls", "Graviti Modifier", {"Disabled", "Low Graviti", "Thanos Snap", "Magnet"}, 0)
local fade_dols = Menu.Switch("Visuals","<uwusense> ragdolls", "Disable Anim", false)

local function menushit()
    light_sw:SetVisible(true)
    m_envLightShadowDirection_x:SetVisible(light_sw:GetBool())
    m_envLightShadowDirection_y:SetVisible(light_sw:GetBool())
    m_envLightShadowDirection_z:SetVisible(light_sw:GetBool())
    m_shadowDirection_x:SetVisible(light_sw:GetBool())
    m_shadowDirection_y:SetVisible(light_sw:GetBool())
    m_shadowDirection_z:SetVisible(light_sw:GetBool())
end


--[[
cl_ragdoll_fade_time 15
cl_ragdoll_forcefade 0 -- for tf2 only
cl_ragdoll_physics_enable 1
g_ragdoll_fadespeed 600
g_ragdoll_lvfadespeed 100
ragdoll_sleepaftertime "5.0f"
]]
print("Welcome to <uwusense> ! I hope you have a nice stay here!\n")

local grav = 200
function gaming()
    local ragdoll_phys = CVar.FindVar("cl_ragdoll_physics_enable")
    local ragdoll_grav = CVar.FindVar("cl_ragdoll_gravity")
    local modes = modes_combo:GetInt()
    if modes == 0 then
        grav = 200
    elseif modes == 1 then
        grav = -100
    ...
    ragdoll_grav:SetInt(grav)
    if fade_dols:GetBool() == true then
        ragdoll_phys:SetInt(0)
    else
        ragdoll_phys:SetInt(1)
    end
end
    ...
    if ui.hitlogs:Get() then
        if reason == 0 then
            if ui.hitlogs_type:Get(1) then
                logs[#logs+1] = {("<uwusense> Hit "..Name.."'s in "..hitboxes[shot.hitgroup+1].." for ".. shot.damage .." dmg (aimed: "..hitboxes[shot.wanted_hitgroup+1]..", hc: "..shot.hitchance..", bt: "..shot.backtrack..", spread: "..string.format("%.1f", shot.spread_degree).."°)"), GlobalVars.tickcount + 300, 0}
            end
            if ui.hitlogs_type:Get(2) then
                print("<uwusense> Hit "..Name.."'s in "..hitboxes[shot.hitgroup+1].." for ".. shot.damage .." dmg (aimed: "..hitboxes[shot.wanted_hitgroup+1]..", hc: "..shot.hitchance..", bt: "..shot.backtrack..", spread: "..string.format("%.1f", shot.spread_degree).."°)")
            end
            if ui.hitlogs_type:Get(3) then
                Cheat.AddEvent("<uwusense> Hit "..Name.."'s in "..hitboxes[shot.hitgroup+1].." for ".. shot.damage .." dmg (aimed: "..hitboxes[shot.wanted_hitgroup+1]..", hc: "..shot.hitchance..", bt: "..shot.backtrack..", spread: "..string.format("%.1f", shot.spread_degree).."°)")
            end
        else
            if ui.hitlogs_type:Get(1) then
                logs[#logs+1] = {("<uwusense> Missed ".. Name .. "'s in " .. hitboxes[shot.wanted_hitgroup+1] .. " due to "..reason_list[reason].." (aimed: "..hitboxes[shot.wanted_hitgroup+1]..", hc: "..shot.hitchance..", bt: "..shot.backtrack..", spread: "..string.format("%.1f", shot.spread_degree).."°)"), GlobalVars.tickcount + 300, 0}
            end
            if ui.hitlogs_type:Get(2) then
                print("<uwusense> Missed ".. Name .. "'s in " .. hitboxes[shot.wanted_hitgroup+1] .. " due to "..reason_list[reason].." (aimed: "..hitboxes[shot.wanted_hitgroup+1]..", hc: "..shot.hitchance..", bt: "..shot.backtrack..", spread: "..string.format("%.1f", shot.spread_degree).."°)")
            end
            if ui.hitlogs_type:Get(3) then
                Cheat.AddEvent("<uwusense> Missed ".. Name .. "'s in " .. hitboxes[shot.wanted_hitgroup+1] .. " due to "..reason_list[reason].." (aimed: "..hitboxes[shot.wanted_hitgroup+1]..", hc: "..shot.hitchance..", bt: "..shot.backtrack..", spread: "..string.format("%.1f", shot.spread_degree).."°)")
            end
        end
    end
end)
...
local draw = function()
    ...
    if #logs > 0 then
        ...
        for i = 1, #logs do
            ...
            Render.Text("<uwusense> ", Vector2.new(math.min(50, logs[i][3]*2)-49 + x/2-ts.x/2, y-249+34*i), Color.RGBA(0,0,0, math.min(255, logs[i][3]*5)), 11, font.verdana)
            Render.Text("<uwusense> ", Vector2.new(math.min(50, logs[i][3]*2)-50 + x/2-ts.x/2, y-250+34*i), Color.RGBA(r,g,b, math.min(255, logs[i][3]*5)), 11, font.verdana)
        end
    end
    ...
    if ui.windows:Get(1) then
        ...
        text_wm = "<uwusense> | "..Cheat.GetCheatUserName().." | delay: "..ping.." | "..string.format("%02d:%02d:%02d", local_time.wHour, local_time.wMinute, local_time.wSecond)
    ...
    if lp:GetPlayer():IsAlive() then
        ...
        if ui.state_panel:Get() then
            ...
            Render.Text("<uwusense> - V1.2.1 | "..Cheat.GetCheatUserName(), Vector2.new(x/20, y/2.4+30), Color.RGBA(255,255,255,255), 10, font.pixel, true)
        ...
        if ui.indicators:Get(1) then
            add_y = 0
            add_y = add_y + 40
            ts = Render.CalcTextSize("uwu-", 10, font.pixel)
            Render.Text("uwu-", Vector2.new(x/2 - ts.x, y/2 + add_y + 2), AntiAim.GetInverterState() and Color.RGBA(r, g, b, 255) or Color.RGBA(255, 255, 255, 255), 10, font.pixel, true)
            Render.Text("sense", Vector2.new(x/2, y/2 + add_y + 2), AntiAim.GetInverterState() and Color.RGBA(255, 255, 255, 255) or Color.RGBA(r, g, b, 255), 10, font.pixel, true)
            add_y = add_y + 14
        ...
        if ui.indicators:Get(2) then
            add_y = 0
            add_y = add_y + 40
            Render_Indicator("<uwusense>", add_y, Color.RGBA(255, 255, 255, 255), 10, font.pixel, true)
            add_y = add_y + 9
        ...
        if ui.indicators:Get(3) then
            add_y = 0
            add_y = add_y + 40
            ts = Render.CalcTextSize("<uwu", 11, font.verdanabd)
            Render.Text("<uwu", Vector2.new(x/2 - ts.x, y/2 + add_y + 2), AntiAim.GetInverterState() and Color.RGBA(r, g, b, 255) or Color.RGBA(255, 255, 255, 255), 11, font.verdanabd, true)
            Render.Text("sense>", Vector2.new(x/2, y/2 + add_y + 2), AntiAim.GetInverterState() and Color.RGBA(255, 255, 255, 255) or Color.RGBA(r, g, b, 255), 11, font.verdanabd, true)
            add_y = add_y + 13
            if HS:Get() then
    ...
    if e:GetName() == "player_hurt" then
        if e:GetInt("attacker", 0) ==  EntityList.GetLocalPlayer():GetPlayerInfo().userId then
            ...
            elseif ui.hitsound:Get() == 2 then
                EngineClient.ExecuteClientCmd("playvol uwusense/hitsound/hitsound.wav 0.75")
...
print("Welcome to <uwusense>,"..Cheat.GetCheatUserName().."!")
print("Version: 1.0")
print("State: Release")
